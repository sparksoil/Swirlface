/* RV Helper — Section D (Color Aging + gentle glimmer) */
...
(function(){
  ...
  function applyGrowth(kind, careFlag){
    ...
    renderList();
    renderCircles();
    if(kind!=='attempt') chkCare.checked = false; // reset for non-attempts
  }
  ...
  function onImport(ev){
    ...
    reader.onload=()=>{
      try{
        ...
        renderList(); renderCircles(); alert('Import complete.');
...
// Signal successful boot for the inline warning in rv-helper.html (optional)
